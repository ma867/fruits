        ...
        return (
            <Default title={`${name} Edit Page`} fruit={this.props.fruit}>
                <form method="POST" action={`/fruits/${_id}?_method=PUT`}>
                    Name: <input type="text" className="form-control" name="name" defaultValue={name}></input><br/>
                    Color: <input type="text" className="form-control" name="color" defaultValue={color}></input><br />
