    ...
    render(){
        ...
        <Default title={`${capName} Show Page`} fruit={this.props.fruit}>
            <div className="user-content">
                ...
                <a className="delete" href={`/fruits/${_id}/edit`}><i className="fa-solid fa-pencil"></i>  Edit </a><br />
                <a className="delete" href={`/fruits/${_id}`}><i className="fa-solid fa-eye"></i>  Details</a><br />
